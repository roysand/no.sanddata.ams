...
{
    public static Error NotFound { get; } = new("User.NotFund", "The specified user was not found.");
    public static Error Exists { get; } = new("User.Exists", "The specified user with email exists.");
    public static Error NoUsersFound { get; } = new("Users.NotFound", "No users were found.");
}